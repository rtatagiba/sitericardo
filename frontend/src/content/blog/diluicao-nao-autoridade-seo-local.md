---
title: "Um site removeu 4 milhões de páginas e ganhou 600 mil cliques a mais"
titulos_alternativos:
  - "Uma página de bairro merece existir? O framework que decide isso"
  - "Mais páginas locais não é mais autoridade, é diluição"
  - "Um site removeu 4 milhões de páginas e ganhou 600 mil cliques a mais"
  - "O framework que evita que sua agência infle o site de páginas inúteis"
  - "40 páginas de bairro não são autoridade, são diluição de sinal"
...
Se a resposta pra maioria dessas perguntas for não, a variação vira seção de uma página já existente, com [internal link](/blog/clareza-e-a-nova-estrategia-seo-ia/) e verbalização de atributo, em vez de virar URL nova.

Vale também reforçar uma regra de priorização que auditoria costuma pular: o [par local mais importante](/blog/como-escolher-as-melhores-palavras-chave-para-seu-negocio-local/), aquele que gera mais negócio pro cliente, deveria ser alvo da página mais forte do site, normalmente a home. A home concentra o PageRank mais alto e costuma ser a página mais rastreada depois do robots.txt, então gastar essa força numa combinação secundária de bairro é desperdiçar o ativo mais valioso que o site tem.
...
Se você trabalha com clientes locais e a agência anterior deixou um rastro de página duplicada por bairro, essa é a munição técnica pra explicar por que menos, nesse caso específico, ranqueia mais — o mesmo princípio que explica por que [tráfego orgânico cresce em curva, não em linha reta](/blog/trafego-organico-benchmark-real/). Pra revisar o básico antes de aplicar esse framework, vale reler [por que SEO local é fundamental pra pequeno negócio](/blog/por-que-seo-local-e-fundamental-para-pequenos-negocios/) e como [acompanhar ranking, conversão e chamada](/blog/sucesso-em-seo-local-como-acompanhar-rankings-conversoes-e-chamadas/) depois da consolidação. Se preferir uma [auditoria de SEO estratégico](/servicos) pra mapear isso no site de um cliente, dá pra começar por aí.

Fonte: [How semantics and topical authority improve local SEO](https://searchengineland.com/how-semantics-and-topical-authority-improve-local-seo-482980), de Koray Tuğberk GÜBÜR, Search Engine Land.
